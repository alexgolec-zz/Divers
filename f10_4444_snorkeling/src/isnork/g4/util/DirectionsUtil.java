...
public class DirectionsUtil {
	...
	public static List<Direction> getForwardDirectionsWhileReturnToBoat(Direction direction){
		List<Direction> fwdDiretions = new ArrayList<Direction>();
		if(direction == Direction.N){
			fwdDiretions.add(Direction.N);fwdDiretions.add(Direction.NE);fwdDiretions.add(Direction.NW);fwdDiretions.add(Direction.E);
			return fwdDiretions;
		}
		if(direction == Direction.S){
			fwdDiretions.add(Direction.S);fwdDiretions.add(Direction.SE);fwdDiretions.add(Direction.SW);fwdDiretions.add(Direction.W);
			return fwdDiretions;
		}
		if(direction == Direction.W){
			fwdDiretions.add(Direction.W);fwdDiretions.add(Direction.NW);fwdDiretions.add(Direction.SW);fwdDiretions.add(Direction.N);
			return fwdDiretions;
		}
		if(direction == Direction.E){
			fwdDiretions.add(Direction.E);fwdDiretions.add(Direction.NE);fwdDiretions.add(Direction.SE);fwdDiretions.add(Direction.S);
			return fwdDiretions;
		}
		if(direction == Direction.NE){
			fwdDiretions.add(Direction.N);fwdDiretions.add(Direction.NE);fwdDiretions.add(Direction.E);fwdDiretions.add(Direction.SE);
			return fwdDiretions;
		}
		if(direction == Direction.NW){
			fwdDiretions.add(Direction.N);fwdDiretions.add(Direction.W);fwdDiretions.add(Direction.NW);fwdDiretions.add(Direction.NE);
			return fwdDiretions;
		}
		if(direction == Direction.SE){
			fwdDiretions.add(Direction.S);fwdDiretions.add(Direction.E);fwdDiretions.add(Direction.SE);fwdDiretions.add(Direction.SW);
			return fwdDiretions;
		}
		if(direction == Direction.SW){
			fwdDiretions.add(Direction.S);fwdDiretions.add(Direction.W);fwdDiretions.add(Direction.SW);fwdDiretions.add(Direction.NW);
			return fwdDiretions;
		}
		return fwdDiretions;
	}
